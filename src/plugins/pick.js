...
export default class HotelDatepicker {
  ...
  showSelectedInfo() {
    ...
    if (this.start && this.end) {
     ...
     night.innerHTML=elSelected.firstElementChild.textContent = countText;
      ...
      this.changed = true;
      inputLeft.value=this.getDateString(new Date(this.start),'MM月DD日');
      inputRight.value=this.getDateString(new Date(this.end),'MM月DD日');
      day1.innerHTML=this.getDateString(new Date(this.start),'ddd')
      day2.innerHTML=this.getDateString(new Date(this.end),'ddd')
    } else {
